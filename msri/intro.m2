...
J = ideal(x*y,z^2) -- same as I

--warning: for M2, an ideal is not a module!
--but you can make it into one by typing
module I
...
--careful: M2 will by default assume computations
--are happening in T, not R, since T was last used
x --M2 will tell us this is an element in T, not R
--if we want to talk about x the element in R,
--we can switch things by doing
use R
--now x is in R
x


--the module R/I and the ring R/I
--are very different things in M2
R/I -- ring
R^1/I -- module
--alternative way:
module R / I
...
--Good rule of thumb:
--if you're done with the previous calculations, 
--and are starting something completely new,
--use restart
restart
...
HH_1(C)
--unfortunately, we cannot read homology
--in degrees 0 and 2:
HH_0(C)
HH_2(C)
...
C.dd
D = res I -- this is also a resolution for R/I, not I
D.dd
--but if you set I as a module,
--you will get a resolution for I:
E = res module I
E.dd
