...
\begin{problem}
	Let $R$ be a local domain and $M$ be a finitely generated $R$-module with $\pdim(M) < \infty$.
	\begin{enumerate}[label=\alph*)]
		...
		\item Show that if $I$ is a nonzero proper ideal in $R$ and $M$ is an $R/I$-module, then
...
\begin{problem}
	...
	\begin{enumerate}[label=\alph*)]
		\item Find the betti numbers of $M$ without finding the minimal free resolution for $M$.
