...
\begin{minipage}{0.95\textwidth}
\vspace{0.2em}
A noetherian local ring $R$ is a complete intersection if $R \cong Q/(\underline{x})$, where $Q$ is a regular local ring and $\underline{x}$ is a regular sequence on $R$.
