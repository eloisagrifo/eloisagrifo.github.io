...
\begin{problem}
	Let $(R, \m)$ be a regular local ring and consider $x \in \m$. Show that $R/(x)$ is regular if and only if $x \in \m \setminus \m^2$.
\end{problem}
...
\begin{problem}
	Let $(R, \m)$ be a noetherian local ring and $I$ be an ideal in $R$.
	\begin{enumerate}[label=\alph*), itemsep=-0.1em]
