...
Given a complex $C$, $\Sigma^{-1} C$ is the complex obtained by shifting $C$ to the left and switching the sign on the differential: 
$$(\Sigma^{-1} C)_n \colonequals C_{n-1} \qquad \textrm{and} \qquad d^{\Sigma^{-1} C}=-d^C.$$
\end{minipage}} 
